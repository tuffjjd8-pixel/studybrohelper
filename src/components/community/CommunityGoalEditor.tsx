...
export const CommunityGoalEditor = ({ userEmail }: CommunityGoalEditorProps) => {
  ...
  if (loading) {
    return (
      <div className="p-4 bg-card rounded-xl border border-border text-center text-sm text-muted-foreground">
  ...
  if (!goal) {
    return (
      <div className="p-4">
        <Button onClick={handleCreate} variant="outline" className="w-full gap-2">
    ...
    >
      ...
      <div className="space-y-4">
        <div className="space-y-1">
          <label className="text-sm font-medium text-muted-foreground">Title (emoji-friendly)</label>
          <Input
            value={goal.title}
        ...
        <div className="space-y-1">
          <label className="text-sm font-medium text-muted-foreground">Body (multiline, emoji-friendly)</label>
          <Textarea
            value={goal.body}
